...
const Landing = () => {
    ...
    return (
        <div className="about-heading">
            ...
            <p className="about-content app-content-body">If you are a student, professional or any individual for that matter, spending money recklessly and noticing it very late is something we all encounter at one point of our lives. This is the part where <b>Gullak</b> comes in to play, Gullak allows you to track all your information in one platform, while providing you the insides you need to make informed, smarted decisions. Moreover, all your data is confidential and only accessible to you. Following are some of the key features of using this application</p>
            <h5 className="app-content">Features:</h5>
            <ul className="app-feature-list about-content app-content-body">
                <li>Dashboard provides all the information you need to look at in one place. This includes your spending of the day/month/year, Transaction History, your current goals, and the best part - a report showing your spending habits</li>
